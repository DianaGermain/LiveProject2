...
public class Homepage extends BasePage{
	...
	public Homepage() throws IOException { // When I create an Object based on the Homepage class,
		super(); 			// I have to provide a WebDriver instance object.
										// The constructor will then use that to update "this.driver"
	} 									// with the object I've passed in
