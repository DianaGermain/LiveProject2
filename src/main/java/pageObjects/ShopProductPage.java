...
public class ShopProductPage extends BasePage {
	...
	By homepageLink = By.xpath("//span[.=\"Home\"]"); ////span[text()="Home"] or //span[.="Home"] -->context item expression)

	public ShopProductPage() throws IOException {  //constructor
		super();
	}
	
	public WebElement getSizeOption() throws IOException {    //public getter method
